...
import com.projects.data.ArrayListDS;
...
public class ArrayListActivity extends AppCompatActivity {
    private StructureInterface arrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleTextView.setText("ArrayList Demonstration");
        arrayList = new ArrayListDS();
        ...
        addButton.setOnClickListener(v -> {
            ...
            if (InputValidator.isValidNumber(input)) {
                arrayList.insert(Integer.parseInt(input));
                updateRecyclerView();
        ...
        removeButton.setOnClickListener(v -> {
            String input = inputEditText.getText().toString();
            if (InputValidator.isValidNumber(input)) {
                arrayList.delete(Integer.parseInt(input));
                updateRecyclerView();
                inputEditText.setText("");
            } else {
                adapter.setError("Error: Invalid input");
    ...
    private void updateRecyclerView() {
        adapter.setData(arrayList.display());
